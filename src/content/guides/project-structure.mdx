...
![A screenshot of the VS Code project with the directory tree shown](@guides/guide-4/directory.png)
...
![A screenshot of the src directory in VS Code. It contains the directories: assets, components, content, data, layouts, lib, pages, and styles. There are files consts.ts and content.config.ts](@guides/)guide-4/source.png)
...
![A screenshot of the root index.astro file found in /src/pages/index.astro](@guides/guide-4/astroFile.png)
